...
import equityRoutes from "./routes/finance/equity";
...
import mrrRoutes from "./routes/sales/mrr";
import alertsRoutes from "./routes/ai/alerts";
...
app.route("/api/finance/equity", equityRoutes);
app.route("/api/sales/mrr", mrrRoutes);
app.route("/api/ai/alerts", alertsRoutes);
